...
{
    public partial class H_ImageC24 : UserControl
    {
        private AxOvkBase.AxImageC24 AxImageC24;
        ...
        public long VegaHandle
        {
            get
            {
                if (this.AxImageC24 != null) return this.AxImageC24.VegaHandle;
                return -1;
            }
        }
        #endregion
        ...
        private void Init()
        {
            if (this.PLC != null && this.Activeform != null && !flag_Init)
            {
                ...
                this.PLC_00_VegaHandle.DoubleValue = AxImageC24.VegaHandle;
                this.flag_Init = true;
            }
        }
            ...
            this.Invoke(new Action(delegate
            {
                ...
                if (this.PLC_01_繪製影像.Bool)
                {
                    ...
                    for (int i = 0; i < this.List_H_Canvas.Count; i++)
                    {
                        ...
                        {
                            this.List_H_Canvas[i].SetImageSize(this.AxImageC24.ImageWidth, this.AxImageC24.ImageHeight);
        ...
        {
            this.AxImageC24.SetSurfacePtr(Width, Height, SurfacePtr);
        }
        public void DrawImage(long HDC, float ZoomX, float ZoomY)
        {
            this.AxImageC24.DrawImage(HDC, ZoomX, ZoomY, 0, 0);
        }
        public bool LoadImage(string filename)
        {
            bool flag = this.AxImageC24.LoadFile(filename);
            if (flag)
            {
                this.PLC_01_ImageWidth.Value = this.AxImageC24.ImageWidth;
                this.PLC_02_ImageHeight.Value = this.AxImageC24.ImageHeight;
            }
            return flag;
        }
        public bool SaveImage(string filename)
        {
            return this.AxImageC24.SaveFile(filename, AxOvkBase.TxAxImageType.AX_IMAGE_FILE_TYPE_GREYLEVEL_BMP);
        }
        #endregion
