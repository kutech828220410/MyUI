...
namespace HsWin
{
    ...
    public class SkinFormProfessionalRenderer : SkinFormRenderer
    {
        ...
        public override Region CreateRegion(HskinMain form)
        {
        ...
        public override void InitSkinForm(HskinMain form)
        {
        ...
        private void DrawBorder(
            Graphics g, Rectangle rect, RoundStyle roundStyle, int radius, HskinMain frm)
        {
        ...
        private void RenderSkinFormCmSysBottomInternal(Graphics g, Rectangle rect, ControlBoxState state, bool active, HskinMain form, CmSysButton cmSysButton)
        {
            Bitmap btm = null;
            Color baseColor = ColorTable.ControlBoxActive;
