...
namespace MyUI
{
    public partial class PLC_RJ_ScreenButtonEx : RJ_Button
    {
        ...
        public void sub_按鈕狀態設為ON()
        {
            ...
            {
                this.BackgroundColor = OnIconColor;
            }
            else
            {
                this.BackgroundColor = OnIconColor;
        ...
        public void sub_按鈕狀態設為OFF()
        {
            if (this.IsHandleCreated == true)
            {
                ...
                {
                    this.BackgroundColor = OffIconColor;
                }));
            }
            else
            {
        ...
        #endregion
        public PLC_RJ_ScreenButtonEx()
        {
            InitializeComponent();

            this.MouseDownEvent += PLC_RJ_ScreenButtonEx_MouseDownEvent;
            this.MouseClickEvent += PLC_RJ_ScreenButtonEx_MouseClickEvent;
            this.MouseUp += PLC_RJ_ScreenButtonEx_MouseUp;
            this.MouseLeave += PLC_RJ_ScreenButtonEx_MouseLeave;
        }
        ...
        #region Event
        private void PLC_RJ_ScreenButtonEx_MouseDownEvent(MouseEventArgs mevent)
        {
            if (this.PLC == null)
            {
        ...
        private void PLC_RJ_ScreenButtonEx_MouseClickEvent(MouseEventArgs mevent)
        {
           
        }


        private void PLC_RJ_ScreenButtonEx_MouseLeave(object sender, EventArgs e)
        {
            //if (IsRunOnce) but_press = false;
        }
        private void PLC_RJ_ScreenButtonEx_MouseUp(object sender, MouseEventArgs e)
        {
            //if (IsRunOnce) but_press = false;
        }
