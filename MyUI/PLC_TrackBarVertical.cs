...
namespace MyUI
{
     [System.Drawing.ToolboxBitmap(typeof(PLC_TrackBarVertical), "PLC_TrackBarVertical.bmp")]
    public partial class PLC_TrackBarVertical : UserControl
    {
        public PLC_TrackBarVertical()
        {
            InitializeComponent();
        }
        ...
        private void trackBar1_Scroll(object sender, EventArgs e)
        {
            if (_讀取元件位置 != "" && PLC != null)
            {
                PLC.properties.Device.Set_Device(_寫入元件位置, trackBar1.Value);
            }
        }
        ...
        private delegate void trackBar_valueUI(int value);
        public void trackBar_value(int value)
        {
        ...
        object value;
        trackBar_valueUI trackBar_valueUI_Invoke;
        public void Run()
        {
            flag_init = true;
            ...
            if (_讀取元件位置 != "" && _讀取元件位置 != null && PLC != null)
            {
                ...
                if (trackBar_value_buf != (int)value)
                {
                    ...
                    if(trackBar_valueUI_Invoke==null) trackBar_valueUI_Invoke = new trackBar_valueUI(trackBar_value);
                    BeginInvoke(trackBar_valueUI_Invoke, trackBar_value_buf);
