...
namespace HsBase
{
    public class ROIC24
    {
        ...
        private void canvas2_CanvasMouseDown(object sender, MouseEventArgs e)
        {
            this.HitTest(e.X, e.Y, defult_ZoomX, defult_ZoomY);
            this.IsMouseDown = true;
        }
        private void canvas2_CanvasMouseMove(object sender, MouseEventArgs e)
        {
            if (this.IsMouseDown)
            {
        ...
        private void canvas2_CanvasMouseUp(object sender, MouseEventArgs e)
        {
        ...
        public void SetDefultEvent(Canvas Canvas, double ZoomX, double ZoomY)
        {
            ...
            {
                Canvas.CanvasMouseDown -= this.canvas2_CanvasMouseDown;
                Canvas.CanvasMouseMove -= this.canvas2_CanvasMouseMove;
                Canvas.CanvasMouseUp -= this.canvas2_CanvasMouseUp;
                flag = true;
            }
        ...
        public void SetImage(IntPtr SurfaceHandle)
        {
            ...
            this.StructDstHandle.ImagePixelFormat = HsBasic.ImageClass.ImagePixelFormat.RGB24;
            this.StructDstHandle.ColorDepth = 3;
